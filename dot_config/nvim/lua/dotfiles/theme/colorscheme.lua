...
local theme = require("dotfiles.theme").current()
local blend = require("dotfiles.theme.palette").blend
...
for name, spec in pairs({
	...
	TodoBgTODO = {
		fg = require("dotfiles.theme.palette").ensure_contrast(p.bg, syntax.blue, 4.5),
		bg = syntax.blue,
		bold = true,
	},
