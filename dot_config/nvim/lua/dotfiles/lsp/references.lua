...
function M.open_float()
	...
	Snacks.picker.lsp_references(project_pickers.picker_scope(project_paths.picker_root()))
end

-- Locations a server hands us directly, rather than ones we requested --
-- ts_ls' `editor.action.showReferences` command (see plugins/lsp/masonlsp.lua).
